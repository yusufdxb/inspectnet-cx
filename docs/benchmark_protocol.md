...
- Workstation latency claims must be produced on the dev workstation (AMD Ryzen 9 9900X + NVIDIA Blackwell consumer GPU) or an equivalent x86_64 host with CUDA; cite device, image size, and the output JSON.
